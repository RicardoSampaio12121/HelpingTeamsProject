...
namespace RESTAuth.Controllers
{
    ...
    public class SecurityController : ControllerBase
    {
        ...
        [AllowAnonymous]
        [HttpPost("login")]
        public async Task <AuthResponse> Login(AuthRequest loginDetalhes) //or ([FromBody] AuthRequest loginDetalhes)
        {
            AuthResponse token = await jWTAuthManager.Authenticate(loginDetalhes);
